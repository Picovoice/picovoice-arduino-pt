# Porcupine Wake Word Engine + Rhino Speech-To-Intent Engine Demo for Arduino (Portuguese language)
...
3. Search for `Picovoice_PT`, then click `INSTALL`.
...
1. Open `File`->`Examples`->`Picovoice_PT`->`MicrocontrollerVoiceAssistantExample`.
