# Picovoice SDK for Arduino boards - Portuguese language
...
1. Compile and upload the `Picovoice_PT/GetUUID` sketch from the `File -> Examples` menu. Copy the UUID of the board
